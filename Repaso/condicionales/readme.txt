...
7. puedeRenovarCarnet(pasoTests, tieneMultasImpagas, pagoImpuestos)
...
8. puedeGraduarse(asistencia, materiasAprobadas, tesisAprobada)
...
11. avanzarSemaforo(colorActual)
...
12. obtenerSensacion(temperatura)
